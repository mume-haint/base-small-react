...
import SkeletonTableContent from "src/components/skeleton/SkeletonTableContent.tsx";
...
export default function ApiPostTable() {
  ...
  const {posts, loading, initPosts, updatePost, deletePost} = useAsyncPostProvider();
              ...
              >
                {headCell.sortable ? <TableSortLabel
                  ...
                  >
                    {headCell.label}
                    <Box
                      sx={{...visuallyHidden}}>{posts._order === 'desc' ? 'sorted descending' : 'sorted ascending'}</Box>
                  </TableSortLabel>
                  : headCell.label
                }
